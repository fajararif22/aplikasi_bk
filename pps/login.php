...
no-repeat center center fixed; background-size: cover;
 ...
 -moz-background-size: cover; -o-background-size: cover;"><div class="login-box">
  <div class="login-logo">
    <h2>Bimbingan Konseling<br>SMK NEGERI 11 BANDUNG</h2></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="php/<?php echo md5('login'); ?>" method="post">
      ...
      <div class="row">
        ...
        <button class="btn btn-primary btn-flat btn-lg" style="width:100%;">Masuk <i class="glyphicon glyphicon-log-in"></i></button>
    </form>
  </div>
</div>
